...
@Component({
  selector: 'app-load-img3',
  templateUrl: './load-img3.component.html',
  styleUrls: ['../load-img/load-img.component.scss']
})
export class LoadImg3Component implements OnInit {
  ...
  showCard() {
    if (this.counter > 48 ) {
      this.imgsrc1 = 'assets/images/' + this.returndeck[this.counter].card_name + '.png';
      this.imgsrc2 = '';
      this.imgsrc3 = '';
    } else {
      this.imgsrc1 = 'assets/images/' + this.returndeck[this.counter].card_name + '.png';
      this.imgsrc2 = 'assets/images/' + this.returndeck[this.counter + 1].card_name + '.png';
      this.imgsrc3 = 'assets/images/' + this.returndeck[this.counter + 2].card_name + '.png';
    }
  }
